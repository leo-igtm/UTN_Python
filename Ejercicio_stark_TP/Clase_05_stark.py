...
# def imprimir_promedio_superheroes(lista_personajes,ingresar_genero):
...
# imprimir_promedio_superheroes(lista_personajes,"F")
...
def imprimir_tipo_color_ojos(lista):
    conteo_color_ojos = {}
    for lista in lista_personajes:
    ...
    for color_ojos,cantidad in conteo_color_ojos.items():        
        print("Personaje Color de ojos: ",color_ojos,"\n", "Cantidad superheroe: ",cantidad) 
        print("<------------------------------------------------------------------------>")

    return conteo_color_ojos,cantidad

imprimir_tipo_color_ojos(lista_personajes)
# M. listar todos los superhéroes agrupados por color de ojos.

def listar_tipo_color_ojos(lista):
    conteo_color_ojos = {}
    for lista in lista_personajes:
        color_ojos = lista['color_ojos'].lower()
        #nombre_heroe = lista['nombre'].upper()
        if color_ojos not in conteo_color_ojos:
            conteo_color_ojos[color_ojos] = 0
            #conteo_color_ojos[nombre_heroe] = []
        conteo_color_ojos[color_ojos] += 1 
...
listar_tipo_color_ojos(lista_personajes)
...
def imprimir_tipo_color_ojos(lista):
    conteo_color_ojos = {}
    for lista in lista_personajes:
        color_ojos = lista['color_pelo'].upper()
        if color_ojos not in conteo_color_ojos:
            conteo_color_ojos[color_ojos] = 0
        conteo_color_ojos[color_ojos] += 1 

    for color_ojos,cantidad in conteo_color_ojos.items():        
        print("Personaje Color de pelo: ",color_ojos,"\n", "Cantidad superheroe: ",cantidad) 
        print("<------------------------------------------------------------------------>")
